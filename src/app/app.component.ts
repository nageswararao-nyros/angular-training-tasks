...
export class AppComponent implements OnInit {
  ...
  mobile="";
  buttonName = 'Save'
  constructor(private userService : UsersService,private validatorService : CustomValidatorService) {
  ...
  // passwordErrorValidator(c: ValidatorFn) : ValidationErrors | null {
